...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('4', 'ZG role', $FILE{/com/openbravo/pos/templates/Role.ZG.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Manager', NULL, '1', FALSE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'Employee', NULL, '2', FALSE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'Guest', NULL, '3', FALSE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('4', 'ZarGate', NULL, '4', TRUE, NULL);
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('18', 'banknote.1000kr', 1, $FILE{/com/openbravo/pos/templates/banknote.1000kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('19', 'banknote.500kr', 1, $FILE{/com/openbravo/pos/templates/banknote.500kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('20', 'banknote.200kr', 1, $FILE{/com/openbravo/pos/templates/banknote.200kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('21', 'banknote.100kr', 1, $FILE{/com/openbravo/pos/templates/banknote.100kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('22', 'banknote.50kr', 1, $FILE{/com/openbravo/pos/templates/banknote.50kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('23', 'coin.20kr', 1, $FILE{/com/openbravo/pos/templates/coin.20kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('24', 'coin.10kr', 1, $FILE{/com/openbravo/pos/templates/coin.10kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('25', 'coin.5kr', 1, $FILE{/com/openbravo/pos/templates/coin.5kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('26', 'coin.1kr', 1, $FILE{/com/openbravo/pos/templates/coin.1kr.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('27', 'coin.50ore', 1, $FILE{/com/openbravo/pos/templates/coin.50ore.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('28', 'Printer.PartialCash', 0, $FILE{/com/openbravo/pos/templates/Printer.PartialCash.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('29', 'Printer.Kitchen', 0, $FILE{/com/openbravo/pos/templates/Printer.Kitchen.xml});
...
INSERT INTO CATEGORIES(ID, NAME) VALUES ('000', 'Standarkategori');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('000', 'Mvafritak');
...
CREATE TABLE TAXES (
    ...
    RATECASCADE TINYINT(1) DEFAULT '0' NOT NULL,
    RATEORDER INTEGER,
    PRIMARY KEY(ID),
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'Mvafritak', '000', NULL, NULL, 0, FALSE, NULL);
...
CREATE TABLE PRODUCTS (
    ...
    STOCKVOLUME DOUBLE,
    IMAGE MEDIUMBLOB,
    ISCOM TINYINT(1) DEFAULT '0' NOT NULL,
    ISSCALE TINYINT(1) DEFAULT '0' NOT NULL,
    ISKITCHENPRINT TINYINT(1) DEFAULT '0' NOT NULL,
