...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    public ProductsEditor(DataLogicSales dlSales, DirtyManager dirty) {
        ...
        m_jKitchenPrint.addActionListener(dirty);
    ...
    public void writeValueEOF() {
        ...
        m_jKitchenPrint.setSelected(false);
        ...
        m_jKitchenPrint.setEnabled(false);
    ...
    public void writeValueInsert() {
        ...
        m_jKitchenPrint.setEnabled(true);
    ...
    public void writeValueDelete(Object value) {
        ...
        m_jKitchenPrint.setSelected(((Boolean)myprod[6]).booleanValue());
    ...
    public Object createValue() throws BasicException {
        ...
        myprod[6] = Boolean.valueOf(m_jKitchenPrint.isSelected());
    ...
    private void initComponents() {
        ...
        m_jKitchenPrint = new javax.swing.JCheckBox();
        ...
        jLabel13.setBounds(10, 200, 150, 14);
        jPanel1.add(m_jAtt);
        m_jAtt.setBounds(160, 200, 170, 20);

        jLabel14.setText(AppLocal.getIntString("label.tokitchenprinter")); // NOI18N
        jPanel1.add(jLabel14);
        jLabel14.setBounds(10, 230, 150, 14);
        jPanel1.add(m_jKitchenPrint);
        m_jKitchenPrint.setBounds(160, 230, 80, 21);
    ...
    private javax.swing.JCheckBox m_jKitchenPrint;
