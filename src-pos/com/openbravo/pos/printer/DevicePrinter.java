...
public interface DevicePrinter {
    ...
    public void printBarCode(String type, String position, String code) throws Exception;

    public void beginLine(int iTextSize) throws Exception;

    public void printText(int iStyle, String sText) throws Exception;

    public void endLine() throws Exception;

    public void endReceipt() throws Exception;
