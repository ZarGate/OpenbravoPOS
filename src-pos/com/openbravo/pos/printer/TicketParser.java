...
public class TicketParser extends DefaultHandler {
    ...
    public void printTicket(Reader in) throws TicketPrinterException {
        ...
        try {
            ...
            throw new TicketPrinterException(LocalRes.getIntString("exception.parserconfig") + System.getProperty("line.separator") + "Printer: " + m_oOutputPrinter.getPrinterName(), ePC);
        } catch (SAXException eSAX) {
            throw new TicketPrinterException(LocalRes.getIntString("exception.xmlfile") + System.getProperty("line.separator") + "Printer: " + m_oOutputPrinter.getPrinterName(), eSAX);
        } catch (IOException eIO) {
            throw new TicketPrinterException(LocalRes.getIntString("exception.iofile") + System.getProperty("line.separator") + "Printer: " + m_oOutputPrinter.getPrinterName(), eIO);
        } catch (Exception ex) {
            throw new TicketPrinterException(LocalRes.getIntString("exception.exception") + System.getProperty("line.separator") + "Printer: " + m_oOutputPrinter.getPrinterName(), ex);
        }
    }
