...
public class ProductInfoExt {
    ...
    protected boolean m_bKitchenPrint;
    ...
    public final boolean isKitchenPrint() {
        return m_bKitchenPrint;
    }

    public final void setKitchenPrint(boolean bValue) {
        m_bKitchenPrint = bValue;
    }
